...
namespace SSX_Modder.FileHandlers.MapEditor
{
    public class MapHandler
    {
        ...
        public List<LinkerItem> PlayerStarts;
        ...
        List<LinkerItem> ReadLinkerItems(string[] Lines)
        {
            ...
            while (true)
            {
                ...
                LinkerItem.UID = Int32.Parse(Lines[LinePos].Substring(82, 10).TrimEnd(' '));
                LinkerItem.Ref = Int32.Parse(Lines[LinePos].Substring(92, 10).TrimEnd(' '));
